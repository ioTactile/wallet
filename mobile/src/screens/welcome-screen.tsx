  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <View
        style={[
          styles.hero,
          { backgroundColor: colors.brand, paddingTop: insets.top + Spacing.six },
        ]}
      >
      ...
      <View style={[styles.body, { paddingBottom: insets.bottom + Spacing.four }]}>
        ...
        <Text style={styles.legal}>
          {t('welcome.legal')} <Text style={styles.legalLink}>{t('welcome.terms')}</Text>{' '}
          {t('welcome.and')} <Text style={styles.legalLink}>{t('welcome.privacy')}</Text>.
        </Text>
      </View>
    </View>
  );
